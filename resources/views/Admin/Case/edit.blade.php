...
@section('content')
    <div class="page-container">
        <form class="form form-horizontal" id="article-add" enctype="multipart/form-data" method="post">
            <input type="hidden" id="id" name="id" value="{{$inf->id}}">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>案例名称：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$inf->title}}" placeholder="" name="caseName" id="caseName">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>案例简介：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="caseIntro" id="caseIntro" cols="" rows="3" class="textarea" style="width:100%;">{{$inf->content}}</textarea>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>装修面积：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$inf->area}}" placeholder="" name="area" id="area">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$des}}" readonly name="caseTeam" placeholder="请点击该框选择设计师" id="caseTeam">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="caseInf" id="caseInf" cols="" rows="" class="textarea" style="height:400px;width:100%;">{{$inf->information}}</textarea>
                </div>
            </div>
            <div class="row cl">
