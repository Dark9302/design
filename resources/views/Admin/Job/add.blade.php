        ...
        <form class="form form-horizontal" id="article-add" enctype="multipart/form-data" method="post">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" name="position" id="position">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" name="salary" id="salary">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" name="qq" id="qq">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">招聘详情：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="jobInf" id="jobInf" cols="" rows="" class="textarea" style="height:400px;width:100%;"></textarea>
                </div>
            </div>
            <div class="row cl">
        ...
        $("#article-add").validate({
            ...
            submitHandler:function(form){
                ...
                $(form).ajaxSubmit({
                    ...
                    type:"post",
                    data:{
                        'position':position,'number':number,'address':address,'salary':salary,
