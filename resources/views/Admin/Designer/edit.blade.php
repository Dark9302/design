        ...
        <form class="form form-horizontal" id="article-add" enctype="multipart/form-data" method="post">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$res->name}}" placeholder="" name="desName" id="desName">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>职务：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$res->post}}" placeholder="" name="desPost" id="desPost">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>从业时间：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$res->work_year}}" placeholder="" name="year" id="year">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$res->style}}" placeholder="" name="style" id="style">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>个人简介：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="desIntro" id="desIntro" cols="" rows="3" class="textarea" style="width:100%;">{{$res->brief}}</textarea>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>设计理念：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="concept" id="concept" cols="" rows="" class="textarea" style="height:200px;width:100%;">{{$res->design_concept}}</textarea>
                </div>
            </div>
            <div class="row cl">
    ...
    <script>
        ...
        $("#article-add").validate({
            ...
            submitHandler:function(form){
                ...
                $(form).ajaxSubmit({
                    url:"{{url('admin/doEditDesigner')}}",
                    type:"post",
                    data:{
                        'id':id,'name':desName,'post':desPost,'work_year':year,'brief':desIntro,
