            ...
            <div class="row">
                <div class="navbar-header">
                    <a href="/" class="navbar-logo vertical-align" title="装饰公司">
                        <div class="vertical-align-middle"><img src="templates/zstyle/min/img/logo.png" alt="装饰公司"
                                                                title="装饰公司"/></div>
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-collapse-toolbar" id="example-navbar-default-collapse">
                    <ul class="nav navbar-nav navbar-right navlist daohang">
                        ...
                        <li class="dropdown margin-left-0 ecodropdown">
                            <a class="dropdown-toggle link " data-toggle="dropdown" href="#" aria-expanded="false"
                        ...
                        <li class="dropdown margin-left-0 ecodropdown">
                            <a class="dropdown-toggle link " data-toggle="dropdown" href="product.html"
                               aria-expanded="false" role="button" title="服务项目">服务项目 <span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-menu-right bullet" role="menu">
                                <li class="visible-xs-block"><a href="#" title="全部">全部</a></li>
                                <li class="dropdown-submenu">
                                    <a href="#" class="" role="button" tabindex="-1">装修案例</a>
                                    <ul class="dropdown-menu animate" role="menu">
                                        <li role="presentation"><a href="/productos" class="" role="menuitem"
                                                                   tabindex="-1">欧式</a></li>
                                        <li role="presentation"><a href="/productzs" class="" role="menuitem"
                                                                   tabindex="-1">中式</a></li>
                                        <li role="presentation"><a href="/productjz" class="" role="menuitem"
                                                                   tabindex="-1">精装</a></li>
                                        <li role="presentation"><a href="/productjian" class="" role="menuitem"
                                                                   tabindex="-1">简装</a></li>
                                    </ul>
                                </li>
                        ...
                        <li class="dropdown margin-left-0 ecodropdown">
                            <a class="dropdown-toggle link " data-toggle="dropdown" href="#" aria-expanded="false"
                               role="button" title="新闻资讯">新闻资讯 <span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-menu-right bullet" role="menu">
                                <li class="visible-xs-block"><a href="#" title="全部">全部</a></li>
    ...
    <div class="col-md-3">
        <div class="row">
            ...
            <div class="met-news-bar">
                ...
                <ul class="column">
                    <li><a href="{{url('news')}}" title="所有文章" target='_self'>所有文章</a></li>
                    <li><a href="{{url('news/1')}}" title="公司新闻">公司新闻</a></li>
                    <li><a href="{{url('news/2')}}" class="active" title="行业动态">行业动态</a></li>
                </ul>
        ...
        <div class="container">
            <div class="row mob-masonry">
                <div class="col-md-3 col-sm-6 col-xs-12 list text-left masonry-item">
                    ...
                    <ul class="social">
                        <li>
                            <a href="http://wpa.qq.com/msgrd?v=3&uin=123456789&site=qq&menu=yes" rel="nofollow"
                ...
                <div class="col-md-3 col-sm-6  list col-xs-12 masonry-item">
                    ...
                    <div class="gallery">
                        ...
                        <a href="showproduct.html" title="客厅" target='_self'><img data-original="upload/f1389850762.jpg"
                                                                                  alt="客厅" title="客厅"></a>

                        <a href="showproduct.html" title="卧室" target='_self'><img data-original="upload/f1389852216.jpg"
                                                                                  alt="卧室" title="卧室"></a>

                        <a href="showproduct.html" title="别墅" target='_self'><img data-original="upload/f1389852083.jpg"
                                                                                  alt="别墅" title="别墅"></a>

                        <a href="showproduct.html" title="公寓" target='_self'><img data-original="upload/f1389852374.jpg"
                                                                                  alt="公寓" title="公寓"></a>
