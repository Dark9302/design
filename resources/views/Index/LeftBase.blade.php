            ...
            <div class="row mob-masonry">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 list ecoinfo text-left masonry-item">
                    ...
                    <ul>
                        ...
                        <li><a href={{url('/news/1')}} target='_self' title="低碳建筑首选天然石材">低碳建筑首选天然石材</a></li>

                        <li><a href={{url('/news/1')}} target='_self' title="装修旺季促销建材家居">装修旺季促销建材家居</a></li>

                        <li><a href={{url('/news/1')}} target='_self' title="全球原木材原料严重紧">全球原木材原料严重紧</a></li>

                        <li><a href={{url('/news/2')}} target='_self' title="将文化融入设计 以设">将文化融入设计 以设</a></li>

                        <li><a href={{url('/news/2')}} target='_self' title="我国玻璃纤维产业规模">我国玻璃纤维产业规模</a></li>
